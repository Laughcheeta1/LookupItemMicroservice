...
public class ItemServiceImplementation implements ItemService{
    ...
    @Autowired
    public ItemServiceImplementation(ItemDAO itemDAO, CategoryDAO categoryDAO, SubCategoryDAO subCategoryDAO, ColorDAO colorDAO, GenderDAO genderDAO, SizeDAO sizeDAO) {
